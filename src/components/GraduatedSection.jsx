          ...
          .map((item) => {
            ...
            if (item["写真"] && item["写真"].includes("drive.google.com")) {
              ...
              if (match && match[1]) {
                ...
                console.warn(
                  "Couldn't extract Google Drive ID from:",
                  item["写真"]
                );
              }
            }
      ...
      <section className="py-20 bg-white">
        <div id={id} className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Lulusan LPK Maleo Gogakuin Palu telah berhasil lolos interview dan
            bekerja di berbagai perusahaan Jepang, membuktikan kualitas
            pelatihan dan pendampingan kami.
          </p>
        </div>
      </section>
    );
      ...
      <div id={id} className="container mx-auto px-4 lg:scroll-mt-10">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-primary-400 mb-4">
            Lulusan Berprestasi Kami
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Para siswa LPK yang telah berhasil lulus interview dan bekerja di
            perusahaan ternama
          </p>
        </div>
        ...
        {graduates.length > 0 ? (
              ...
              <div key={graduate.id} className="px-2 focus:outline-none mb-4">
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition duration-300 h-[420px] flex flex-col">
                  ...
                  <div className="p-4 flex flex-col flex-grow">
                    ...
                    <h3 className="text-lg font-semibold text-gray-800 mb-4 mt-2 line-clamp-1">
                      {graduate.name}
                    </h3>
                    ...
                    <div className="flex items-start mb-2">
                      ...
                      <span className="text-sm text-gray-600 line-clamp-2 flex-grow">
                        {graduate.company}
                      </span>
                    </div>
                    ...
                    <div className="space-y-2 mb-6">
                      ...
                      <div className="flex items-center text-gray-600 text-sm">
                        ...
                        <span>
                          Berangkat:{" "}
                          {graduate.departureDate || "Belum ditentukan"}
                        </span>
                      </div>
                    </div>
          ...
          <div className="text-center py-10">
            <p className="text-gray-600">
              Tidak ada data lulusan yang tersedia
            </p>
          </div>
        )}
      </div>
