...
const ContactSection = ({ id }) => {
  ...
  return (
    <section className="py-12 bg-gray-50">
      <div
        id={id}
        className="container md:mx-auto md:px-4 lg:mx-auto lg:px-4 lg:scroll-mt-10"
      >
        <h2 className="text-3xl font-bold text-center text-primary-400 mb-12">
          Kontak Kami
        </h2>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <address className="not-italic text-gray-600">
                      LPK Maleo Gogakuin Palu
                      <br />
                      Jl. Undata No. 27, Palu, Sulawesi Tengah, Indonesia
                    </address>
                    <a
